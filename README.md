...
Three column blog CMS is used to present data in three column .First column for leftsidebar , second column for blog post description and third column for right sidebar.
